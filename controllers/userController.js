...
paypal.configure({
  ...
  client_id: 'AQ6UngTzAsKoTY2MJgQXKNN8IlBXa-E3i7NxRp2LZxVlylz-nkr0YouK5oFfo2A1S0qJTJdWDBf2Vinf',
  client_secret: 'EB1uDEP7CQNPf0O3wp18_WbRQPXBp6KAp0uBf2GBcbPAijqT_eH96NZpuiMQppA_uj0OK5zwmj8GgRnw',
});
...
const getUserDetails = async (req,res) =>{
  ...
  try {
    ...
    if (foundUser) {
      ...
      const users_published_books = await Book.find({ _id: { $in: publishedBooks } })
